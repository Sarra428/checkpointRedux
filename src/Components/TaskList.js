...
function TaskList() {
  ...
  <Button variant="outline-warning" onClick={()=> {setFilter(true); setDone(false)}} >Show All Done</Button>{' '}
  <Button variant="outline-danger"  onClick={()=> {setFilter(true); setDone(true)}}  >Show All Not Done</Button>{' '}
